    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 space-y-6 shadow-2xl">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-100">Register Merchant Account</h1>
          <p className="text-xs text-slate-400">Set up isolated merchant revenue recovery environment</p>
        </div>
        ...
        <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-500 border-t border-slate-800 pt-4">
          ...
          <span>Argon2id Hashed Passwords • Isolated Merchant Environment</span>
        </div>
      </div>
    </div>
  );
